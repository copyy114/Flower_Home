  ...
  <section id="flower_25" >
    <div class="container">
      <div class="section-title">
        <h2 style="font-family: Kanit, sans-serif;">แจกันดอกไม้</h2>
        <hr>
      </div>
      ...
      <div class="row">
        ...
        $sql = "SELECT id, name, description, prev_price, current_price, img_path FROM tbproduct WHERE type_shop = 'flower_vase'";
